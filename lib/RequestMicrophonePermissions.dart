...
class RequestMicrophonePermissionsPage extends StatefulWidget {

  RequestMicrophonePermissionsPage({ Key? key}) : super(key: key);

  @override
  _RequestMicrophonePermissionsPageState createState() => _RequestMicrophonePermissionsPageState();
}

class _RequestMicrophonePermissionsPageState extends State<RequestMicrophonePermissionsPage> {
                ...
                child: Column(
                  ...
                  // Form Title
                    ...
                    Container(
                      ...
                      child: Container(
                          color: Colors.transparent,
                          child: const Text("The application needs to allow Access to record audio in order to enable all features to function properly such as AI Analysis, reports and medical files ",textAlign: TextAlign.center,
