...
class SymptomsPage extends StatefulWidget {
  final SymptomsStorage storage;

  SymptomsPage({Key? key, required this.storage}) : super(key: key);
...
class _SymptomsPageState extends State<SymptomsPage>  {
  ...
  var NoAddedTitle = ["No added Symptoms, Please Add new","لا توجد أعراض مضافة ، الرجاء إضافة جديد",""];
  ...
  void initState() {
    ...
    widget.storage._readData("icare_symptoms").then((String value) async{
      if(value != "No Data" && value != "")
        {
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DeleteItemListPage(DirName: 'Symptoms', FileName: 'icare_Symptoms', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "symptoms")
                        )),
                    );
                  }
              ),
