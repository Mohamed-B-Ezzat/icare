...
import 'EditViewLabTests.dart';


class LabTestsPage extends StatefulWidget {
  final LabTestsStorage storage;

  LabTestsPage({Key? key, required this.storage}) : super(key: key);
...
class _LabTestsPageState extends State<LabTestsPage>  {
  ...
  var NoAddedTitle = ["No added Lab Tests, Please Add new","لا توجد فحوصات معملية مضافة ، الرجاء إضافة جديد",""];
  ...
  void initState() {
    ...
    widget.storage._readData("icare_labtests").then((String value) async{
      if(value != "No Data" && value != "")
      {
      ...
      else
      {
        Fluttertoast.showToast(
            msg: "No added LabTests, Please Add now.",
                  ...
                  child: Data != null && ImageList != null
                    ...
                    children: [
                      ...
                      const Card(
                        ...
                        child: ListTile(
                          title: Text("No added LabTests, Please Add new",
              ...
              Navigator.pushReplacement(context,
                  MaterialPageRoute(builder:
                      (context) =>
                          Directionality( // use this
                              textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                              child: EditViewLabTestsPage(type: false, Data: DataTitle+"\n"+DataSubTitle+"\n")),
                  )
              );
            }
        ),
                    ...
                    Navigator.pushReplacement(context,
                        MaterialPageRoute(builder:
                            (context) =>
                                Directionality( // use this
                                    textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                                    child: DeleteItemListPage(DirName: 'LabTests', FileName: 'icare_labtests', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "labtests")
                        )),
                    );
                  }
              ),
