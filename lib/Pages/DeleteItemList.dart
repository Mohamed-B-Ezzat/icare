...
class DeleteItemListPage extends StatefulWidget {
  ...
  DeleteItemListPage({Key? key, required this.DataTitle, required this.DataIndex, required this.DataLines, required this.FileName, required this.DirName, required this.DataImage}) : super(key: key);

  @override
  _DeleteItemListPageState createState() =>   _DeleteItemListPageState(this.DataTitle, this.DataIndex, this.DataLines, this.FileName, this.DirName, this.DataImage);

}
class _DeleteItemListPageState extends State<DeleteItemListPage>  {
  ...
  var DirName;
  var DataImage;
  _DeleteItemListPageState(this.DataTitle, this.DataIndex, this.DataLines, this.FileName, this.DirName, this.DataImage);
                            ...
                            switch (DirName)
                            {
                              case "Vital Signs":
                                Navigator.pushReplacement(context,
                                    MaterialPageRoute(builder:
                                        (context) =>
                                            PrescriptionsPage(storage: PrescriptionsStorage(), key: null,)
                                    )
                                );
                                break;
                              case "Prescriptions":
                              ...
                              case "Lab Tests":
                                Navigator.pushReplacement(context,
                                    MaterialPageRoute(builder:
                                        (context) =>
                                            LabTestsPage(storage: LabTestsStorage(), key: null,)
                                    )
                                );
                                break;
                              case "Vaccinations":
                                Navigator.pushReplacement(context,
                                    MaterialPageRoute(builder:
                                        (context) =>
                                            VaccinationsPage(storage: VaccinationsStorage(), key: null,)
                                    )
                                );
                                break;
                              case "Symptoms":
                                Navigator.pushReplacement(context,
                                    MaterialPageRoute(builder:
                                        (context) =>
                                            SymptomsPage(storage: SymptomsStorage(), key: null,)
                                    )
                                );
                                break;
                              case "Scans":
                                Navigator.pushReplacement(context,
                                    MaterialPageRoute(builder:
                                        (context) =>
                                            ScansPage(storage: ScansStorage(), key: null,)
                                    )
                                );
                                break;
                              case "Allergies":
                                Navigator.pushReplacement(context,
                                    MaterialPageRoute(builder:
                                        (context) =>
                                            AllergiesPage(storage: AllergiesStorage(), key: null,)
                                    )
                                );
                                break;
                              default:
                      ...
                      onPressed: () async{
                        try {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => LabTestsPage(storage: LabTestsStorage(), key: null,)),
                          );
                          setState(() {
                            showProgress = false;
                          });
