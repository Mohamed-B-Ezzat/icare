...
class PrescriptionsPage extends StatefulWidget {
  final PrescriptionsStorage storage;

  PrescriptionsPage({Key? key, required this.storage}) : super(key: key);
...
class _PrescriptionsPageState extends State<PrescriptionsPage>  {
  ...
  var NoAddedTitle = ["No added Prescriptions, Please Add new","لا توجد وصفات طبية مضافة ، الرجاء إضافة جديد",""];
  ...
  void initState() {
    ...
    widget.storage._readData("icare_prescriptions").then((String value) async{
      if(value != "No Data")
      {
      ...
      else
      {
        Fluttertoast.showToast(
            msg: "No added Prescriptions, Please Add now.",
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DeleteItemListPage(DirName: 'Prescriptions', FileName: 'Prescriptions', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "prescriptions")
                        )),
                    );
                  }
              ),
