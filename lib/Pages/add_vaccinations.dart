...
class AddVaccinations extends StatefulWidget {
  final AddVaccinationsStorage storage;

  AddVaccinations({Key? key, required this.storage}) : super(key: key);
  @override
  _AddVaccinationsState createState() => _AddVaccinationsState();
}
class _AddVaccinationsState extends State<AddVaccinations>  {

  var LanguageData =0;
  var Title = ["Vaccinations","التطعيمات",""];
  var AddTitle = ["Add Vaccination","اضافة تطعيم",""];
  var DateTitle = ["Date","التاريخ",""];
  var NameTitle = ["Vaccine Name","اسم اللقاح",""];
