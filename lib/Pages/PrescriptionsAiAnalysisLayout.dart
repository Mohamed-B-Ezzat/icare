...
class PrescriptionsAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final PrescriptionsAnalysisStorage storage;
  final PrescriptionsPdfReport PrintPdf;
  final PrescriptionsActiveIngredients IngeredientsStorage;

  PrescriptionsAiAnalysisLayoutPage({ required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.IngeredientsStorage}) : super(key: key);

  @override
  _PrescriptionsAiAnalysisLayoutPageState createState() => _PrescriptionsAiAnalysisLayoutPageState(this.FromDate, this.ToDate, this.AnalysisModule);
}

class _PrescriptionsAiAnalysisLayoutPageState extends State<PrescriptionsAiAnalysisLayoutPage>  {

  var FromDate;
  var ToDate;
  var AnalysisModule;
  _PrescriptionsAiAnalysisLayoutPageState(this.FromDate, this.ToDate, this.AnalysisModule);
...
class PrescriptionsAnalysisStorage
{
...
class PrescriptionsActiveIngredients
{
