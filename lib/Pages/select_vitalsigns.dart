...
import '../Widgets/ImageFromGalleryEx.dart';
  ...
  class SelectVitalSigns extends StatefulWidget {
    final SelectVitalSignsStorage storage;

    SelectVitalSigns({Key? key, required this.storage}) : super(key: key);

    @override
  _SelectVitalSignsState createState() => _SelectVitalSignsState();
  }

  class _SelectVitalSignsState extends State<SelectVitalSigns>  {
