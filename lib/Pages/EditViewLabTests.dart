...
class EditViewLabTestsPage extends StatefulWidget {
  ...
  EditViewLabTestsPage({Key? key, required this.type, required this.Data}) : super(key: key);
  @override
  _EditViewLabTestsPageState createState() => _EditViewLabTestsPageState();
}
                                      ...
                                      if (ListData != "") {
                                        ...
                                        else
                                        {
                                          Navigator.pushReplacement(context,
                                              MaterialPageRoute(builder:
                                                  (context) =>
                                                  EditViewLabTestsPage(type: true, Data: DataToDisplay[0]+"\n"+DataToDisplay[1]+"\n"+DataToDisplay[2])
                                              )
                                          );
                                        }
                                      }
