...
import 'package:icare/Pages/EditViewScans.dart';
...
class ScansPage extends StatefulWidget {
  final ScansStorage storage;

  ScansPage({Key? key, required this.storage}) : super(key: key);
  @override
...
class _ScansPageState extends State<ScansPage>  {
  ...
  var NoAddedTitle = ["No added Scans, Please Add new","لا توجد أشعة مضافة ، الرجاء إضافة جديد",""];
  ...
  void initState() {
    ...
    widget.storage._readData("icare_scans").then((String value) async{
      if(value != "No Data" && value != "")
      {
...
class DataListViewWidget extends StatelessWidget {
  ...
  const DataListViewWidget({required Key? key, required this.LanguageData, required this.DataTitle, required this.DataSubTitle,required this.DataIndex, required this.DataLines, required this.imageURL, required this.Description}) : super(key: key);
        ...
        GestureDetector(
          ...
          onTap: ()
          {
            Navigator.pushReplacement(context,
                ...
                Directionality( // use this
                    textDirection: LanguageData == 1 ?ui.TextDirection.rtl :ui.TextDirection.ltr ,
                    child: EditViewScansPage(type: false, Data: DataTitle+"\n"+DataSubTitle+"\n"+Description)
                ),),
            );
          },
        ),
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?ui.TextDirection.rtl :ui.TextDirection.ltr ,
                            child: EditViewScansPage(type: true, Data: DataTitle+"\n"+DataSubTitle+"\n"+Description)
                        )),
                    );
                  }
              ),
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?ui.TextDirection.rtl :ui.TextDirection.ltr ,
                            child: DeleteItemListPage(DirName: 'Scans', FileName: 'icare_Scans', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "scans")
                        )),
                    );
                  }
              ),
