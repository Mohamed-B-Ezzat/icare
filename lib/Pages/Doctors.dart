...
import 'package:icare/Pages/add_doctors.dart';
...
class DoctorsPage extends StatefulWidget {
  final DoctorsStorage storage;

  DoctorsPage({Key? key, required this.storage}) : super(key: key);
...
class _DoctorsPageState extends State<DoctorsPage>  {
  ...
  var NoAddedDoctorsTitle = ["No added Doctors, Please Add new","لا يوجد أطباء مضافين ، الرجاء إضافة جديد",""];
  ...
  void initState() {
    ...
    widget.storage._readData("icare_Doctors").then((String value) async{
      if(value != "No Data" && value != "")
      {
      ...
      else
      {
        Fluttertoast.showToast(
            msg: NoAddedDoctorsTitle[LanguageData],
        ...
        Navigator.pushReplacement(context,
            ...
            Directionality( // use this
                ...
                child: AddDoctors(storage: AddDoctorsStorage(),),)
            )
        );
      }
                  ...
                  child: Data != null && ImageList != null
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        child: ListTile(
                          title: Text(NoAddedDoctorsTitle[LanguageData],
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DeleteItemListPage(DirName: 'Doctors', FileName: 'icare_Doctors', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "doctors")
                        )),
                    );
                  }
              ),
