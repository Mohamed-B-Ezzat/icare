...
class LabtestsAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final LabtestsAnalysisStorage storage;
  final LabtestsPdfReport PrintPdf;
  final LabtestsRecommendations RecommendationsStorage;

  LabtestsAiAnalysisLayoutPage({ required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.RecommendationsStorage}) : super(key: key);

  @override
  _LabtestsAiAnalysisLayoutPageState createState() => _LabtestsAiAnalysisLayoutPageState(this.FromDate, this.ToDate, this.AnalysisModule);
}

class _LabtestsAiAnalysisLayoutPageState extends State<LabtestsAiAnalysisLayoutPage>  {

  var FromDate;
  var ToDate;
  var AnalysisModule;
  _LabtestsAiAnalysisLayoutPageState(this.FromDate, this.ToDate, this.AnalysisModule);
