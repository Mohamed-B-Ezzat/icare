...
import 'package:icare/Pages/add_appointments.dart';
...
class AppointmentsPage extends StatefulWidget {
  final AppointmentsStorage storage;

  AppointmentsPage({Key? key, required this.storage}) : super(key: key);
...
class _AppointmentsPageState extends State<AppointmentsPage>  {
  ...
  var NoAddedTitle = ["No added Appointments, Please Add new","لا توجد مواعيد مضافة ، الرجاء إضافة جديد",""];
  ...
  void initState() {
    ...
    widget.storage._readData("icare_appointments").then((String value) async{
      if(value != "No Data")
      {
      ...
      else
      {
        Navigator.pushReplacement(context,
            ...
            Directionality( // use this
                ...
                child: AddAppointments(storage: AddAppointmentsStorage(),)),
            )
        );
      }
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DeleteItemListPage(DirName: 'Appointments', FileName: 'icare_appointments', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "appointments")
                        )),
                    );
                  }
              ),
