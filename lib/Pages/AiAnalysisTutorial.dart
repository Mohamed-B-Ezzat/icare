...
class AiAnalysisTutorialPage extends StatefulWidget {

  AiAnalysisTutorialPage({ Key? key}) : super(key: key);

  @override
  _AiAnalysisTutorialPageState createState() => _AiAnalysisTutorialPageState();
}

class _AiAnalysisTutorialPageState extends State<AiAnalysisTutorialPage> {
  ...
  var AIAnalysisFeatureTitle = ["The AI Analysis  Feature","ميزة تحليل الذكاء الاصطناعي",""];
  var NullBodyTitle = ["ICare AI Analysis  Feature","ميزة ICare تحليل الذكاء الاصطناعي",""];
  ...
  List Body = [["You can track up to 3 vital signs in an unlimited period of time among their max, min and average.",
    ...
    "You can print and share of available reports:\n- Standalone report for unlimited period of time (Vital Signs, Prescriptions, Vaccinationa, lab Test, Scan tests, Allergies,.....)\n- Total Health Report (Weekly, Monthly, period of time).",
    "You can track up to 3 vital signs in an unlimited period of time among their max, min and average."],["يمكنك تتبع ما يصل إلى 3 علامات حيوية في فترة زمنية غير محدودة بين الحد الأقصى والدقيق والمتوسط." ,
    "يمكنك طباعة ومشاركة التقارير المتاحة: "+"\n"+"- تقرير مستقل لفترة زمنية غير محدودة (الإشارات الحيوية , والوصفات الطبية , واللقاحات , والاختبار المعملي , واختبارات المسح , والحساسية , .....) "+"\n"+"- التقرير الصحي الإجمالي (أسبوعيًا) , شهرية , فترة زمنية). ",
    "يمكنك طباعة ومشاركة التقارير المتاحة: "+"\n"+"- تقرير مستقل لفترة زمنية غير محدودة (الإشارات الحيوية , والوصفات الطبية , واللقاحات , والاختبار المعملي , واختبارات المسح , والحساسية , .....) "+"\n"+"- التقرير الصحي الإجمالي (أسبوعيًا) , شهرية , فترة زمنية). ",
    "يمكنك تتبع ما يصل إلى 3 إشارات حيوية في فترة زمنية غير محدودة بين الحد الأقصى والحد الأدنى والمتوسط."],[]];
                  ...
                  child: Column(
                    ...
                    child:Container(
                      ...
                      Container(
                        ...
                        child: Container(
                          color: Colors.transparent,
                          child: Text(AIAnalysisFeatureTitle[LanguageData],
                            style: const TextStyle(color: Color.fromRGBO(32, 116, 150, 1.0),
                              fontSize: 20,
                              fontWeight: FontWeight.w900,
                            ),),
