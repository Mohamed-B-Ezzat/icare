...
class DependentReportsLayoutPage extends StatefulWidget {
  String FromDate, ToDate;
  final DependentReportsStorage storage;
  final DependentReportsPdfReport PrintPdf;
  final String DirName;
  final String DataTitle;
  final String DataImage;

  DependentReportsLayoutPage({ required this.DataTitle, required this.DataImage,required this.DirName,required this.FromDate, required this.ToDate, Key? key, required this.storage, required this.PrintPdf}) : super(key: key);

  @override
  _DependentReportsLayoutPageState createState() => _DependentReportsLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate);
}

class _DependentReportsLayoutPageState extends State<DependentReportsLayoutPage>  {
  ...
  var DataTitle;
  var DataImage;
  _DependentReportsLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate);
...
class DependentReportsPdfReport
{
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/Reports');
