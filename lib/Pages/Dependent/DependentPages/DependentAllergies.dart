...
class DependentAllergiesPage extends StatefulWidget {
  final DependentAllergiesStorage storage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentAllergiesPage({Key? key,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);
  @override
  _DependentAllergiesPageState createState() => _DependentAllergiesPageState(this.DataTitle, this.DataImage,this.DirName);
}
class _DependentAllergiesPageState extends State<DependentAllergiesPage>  {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentAllergiesPageState(this.DataTitle, this.DataImage,this.DirName);
  ...
  void initState() {
    ...
    widget.storage._readData(DirName.toString(),"icare_allergies").then((String value) async{
      if(value != "No Data" && value != "")
      {
      ...
      else
      {
        Fluttertoast.showToast(
            msg: "No added DependentAllergies, Please Add now.",
                  ...
                  child: Data != null && ImageList != null
                    ...
                    children: [
                      ...
                      const Card(
                        ...
                        child: ListTile(
                          title: Text("No added DependentAllergies, Please Add new",
...
class DependentAllergiesStorage
{
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DependentDeleteItemListPage(DirName: 'DependentAllergies', FileName: 'icare_DependentAllergies', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "DependentAllergies")
                        )
                    ));
                  }
              ),
