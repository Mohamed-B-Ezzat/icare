...
class DependentAllergiesAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final DependentAllergiesAnalysisStorage storage;
  final DependentAllergiesPdfReport PrintPdf;
  final DependentAllergiesRecommendations RecommendationsStorage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentAllergiesAiAnalysisLayoutPage({required this.DataTitle, required this.DataImage,required this.DirName, required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.RecommendationsStorage}) : super(key: key);

  @override
  _DependentAllergiesAiAnalysisLayoutPageState createState() => _DependentAllergiesAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
}

class _DependentAllergiesAiAnalysisLayoutPageState extends State<DependentAllergiesAiAnalysisLayoutPage>  {
  var DirName;
  var DataTitle;
  var DataImage;
  var FromDate;
  var ToDate;
  var AnalysisModule;
  _DependentAllergiesAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
...
class DependentAllergiesAnalysisStorage
{
...
class DependentAllergiesPdfReport
{
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/AIAnalysis');
...
class DependentAllergiesRecommendations
{
