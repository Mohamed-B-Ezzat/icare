...
class DependentVaccinationsPage extends StatefulWidget {
  final DependentVaccinationsStorage storage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentVaccinationsPage({Key? key,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentVaccinationsPageState createState() => _DependentVaccinationsPageState(this.DataTitle, this.DataImage,this.DirName);

}

class _DependentVaccinationsPageState extends State<DependentVaccinationsPage>  {
  var DirName;
  var DataTitle;
  var DataImage;

  _DependentVaccinationsPageState(this.DataTitle, this.DataImage,this.DirName);
  ...
  void initState() {
    ...
    widget.storage._readData(DirName.toString(),"icare_vaccinations").then((String value) async{
      if(value != "No Data" && value != "")
      {
      ...
      else
      {
        Fluttertoast.showToast(
            msg: "No added Symptoms, Please Add now.",
                  ...
                  child: Data != null && ImageList != null
                    ...
                    children: [
                      ...
                      const Card(
                        ...
                        child: ListTile(
                          title: Text("No added Dependent Vaccinations, Please Add new",
...
class DependentVaccinationsStorage
{
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DependentDeleteItemListPage(DirName: 'DependentVaccinations', FileName: 'icare_DependentVaccinations', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "DependentVaccinations")
                        )
                        )
                    );
                  }
