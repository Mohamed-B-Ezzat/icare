...
class DependentPrescriptionsPage extends StatefulWidget {
  final DependentPrescriptionsStorage storage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentPrescriptionsPage({Key? key,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentPrescriptionsPageState createState() => _DependentPrescriptionsPageState(this.DataTitle, this.DataImage,this.DirName);
}
class _DependentPrescriptionsPageState extends State<DependentPrescriptionsPage>  {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentPrescriptionsPageState(this.DataTitle, this.DataImage,this.DirName);
  ...
  void initState() {
    ...
    widget.storage._readData(DirName.toString(),"icare_prescriptions").then((String value) async{
      if(value != "No Data")
      {
      ...
      else
      {
        Fluttertoast.showToast(
            msg: "No added DependentPrescriptions, Please Add now.",
                  ...
                  child: Data != null && ImageList != null
                    ...
                    children: [
                      ...
                      const Card(
                        ...
                        child: ListTile(
                          title: Text("No added Symptoms, Please Add new",
...
class DependentPrescriptionsStorage
{
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DependentDeleteItemListPage(DirName: 'DependentPrescriptions', FileName: 'icare_prescriptions', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "DependentPrescriptions")
                        )
                        )
                    );
                  }
