...
class DependentVitalSignsAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final DependentVitalSignsAnalysisStorage storage;
  final DependentVitalSignsPdfReport PrintPdf;
  final DependentVitalSignsActiveIngredients IngeredientsStorage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentVitalSignsAiAnalysisLayoutPage({ required this.DataTitle, required this.DataImage,required this.DirName,required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.IngeredientsStorage}) : super(key: key);

  @override
  _DependentVitalSignsAiAnalysisLayoutPageState createState() => _DependentVitalSignsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
}

class _DependentVitalSignsAiAnalysisLayoutPageState extends State<DependentVitalSignsAiAnalysisLayoutPage>  {
  ...
  var DataTitle;
  var DataImage;
  _DependentVitalSignsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
...
class DependentVitalSignsAnalysisStorage
{
...
class DependentVitalSignsPdfReport
{
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/AIAnalysis');
...
class DependentVitalSignsActiveIngredients
{
