...
import 'Dependentadd_doctors.dart';


class DependentDoctorsPage extends StatefulWidget {
  final DependentDoctorsStorage storage;

  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentDoctorsPage({Key? key,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentDoctorsPageState createState() => _DependentDoctorsPageState(this.DataTitle, this.DataImage,this.DirName);
}

class _DependentDoctorsPageState extends State<DependentDoctorsPage> {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentDoctorsPageState(this.DataTitle, this.DataImage,this.DirName);
  ...
  void initState() {
    ...
    widget.storage._readData(DirName.toString(),"icare_doctors").then((String value) async{
      if(value != "No Data" && value != "")
      {
      ...
      else
      {
        Fluttertoast.showToast(
            msg: "No added DependentDoctors, Please Add now.",
        ...
        Navigator.pushReplacement(context,
            ...
            Directionality( // use this
                ...
                child: DependentAddDoctors(DataImage: DataImage.toString(),DataTitle: DataTitle.toString(),DirName: DirName.toString(),storage: DependentAddDoctorsStorage(),)
            )
            )
        );
      }
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                DependentAddDoctors(DataImage: DataImage.toString(),DataTitle: DataTitle.toString(),DirName: DirName.toString(),storage: DependentAddDoctorsStorage(),)
                        ),
                      );
                    },
                  ),
                  ...
                  child: Data != null && ImageList != null
                    ...
                    children: [
                      ...
                      const Card(
                        ...
                        child: ListTile(
                          title: Text("No added DependentDoctors, Please Add new",
              ...
              GestureDetector(
                  ...
                  onTap: (){
                    Navigator.pushReplacement(context,
                        ...
                        Directionality( // use this
                            textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                            child: DependentDeleteItemListPage(DirName: 'DependentDoctors', FileName: 'icare_doctors', DataIndex: DataIndex, DataTitle: DataSubTitle, DataLines: DataLines, DataImage: "DependentDoctors")
                        )
                        )
                    );
                  }
