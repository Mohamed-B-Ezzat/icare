...
import 'DependentSymptoms.dart';
  ...
  class DependentAddSymptoms extends StatefulWidget {
  final DependentAddSymptomsStorage storage;

  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentAddSymptoms({Key? key,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentAddSymptomsState createState() => _DependentAddSymptomsState(this.DirName,this.DataTitle,this.DataImage);
}

class _DependentAddSymptomsState extends State<DependentAddSymptoms> {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentAddSymptomsState(this.DirName,this.DataTitle,this.DataImage);
  ...
  void _handleURLButtonPress(BuildContext context, var type) {
    Navigator.push(context,
        ...
        child: DependentImageFromGalleryEx(DirName: DirName.toString(),type: type, TypePath: "/Symptoms", storage: ImageStorage(),),)));
  }
...
class DependentAddSymptomsStorage
{
