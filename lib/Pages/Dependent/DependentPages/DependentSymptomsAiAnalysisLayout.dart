...
class DependentSymptomsAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final DependentSymptomsAnalysisStorage storage;
  final DependentSymptomsPdfReport PrintPdf;
  final DependentSymptomsActiveRecommendations RecommendationsStorage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentSymptomsAiAnalysisLayoutPage({ required this.DataTitle, required this.DataImage,required this.DirName, required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.RecommendationsStorage}) : super(key: key);

  @override
  _DependentSymptomsAiAnalysisLayoutPageState createState() => _DependentSymptomsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
}

class _DependentSymptomsAiAnalysisLayoutPageState extends State<DependentSymptomsAiAnalysisLayoutPage>  {
  ...
  var DataTitle;
  var DataImage;
  _DependentSymptomsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
        ...
        switch (AnalysisModule) {
          ...
          default:
            Navigator.pushReplacement(context,
                ...
                Directionality( // use this
                    textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                    child: DependentAiAnalysisHomePage(DataImage: DataImage.toString(),DataTitle: DataTitle.toString(),DirName: DirName.toString(),
                    DependentAnalysisTutorialStatus: DependentAnalysisTutorialStorage())))
            );
            break;
        }
...
class DependentSymptomsAnalysisStorage
{
...
class DependentSymptomsPdfReport
{
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/AIAnalysis');
...
class DependentSymptomsActiveRecommendations
{
