...
class EditViewLabTestsPage extends StatefulWidget {
  final  String Data;
  final String DirName;
  final bool type; // false for view and true for edit
  EditViewLabTestsPage({Key? key, required this.type, required this.Data, required this.DirName}) : super(key: key);
  @override
  _EditViewLabTestsPageState createState() => _EditViewLabTestsPageState(this.type, this.Data, this.DirName);
}

class _EditViewLabTestsPageState extends State<EditViewLabTestsPage>  {
  var DirName;
  var Data;
  var type;

  _EditViewLabTestsPageState(this.Data, this.type,this.DirName);

  TextEditingController DateController = TextEditingController();
  TextEditingController DescriptionController = TextEditingController();
  TextEditingController GeneralLabTestsController = TextEditingController();
  ...
  void initState() {
    ...
    if (ListData != "") {
      ...
      if (DataToDisplay.isEmpty) {
        ...
        //         (context) =>
        //             DependentScansPage(storage: DependentScansStorage())
        //     )
        // );
      }
      else
        {
          ...
          _GeneralLabTestsTxt = DataToDisplay[1];
          GeneralLabTestsController.text = DataToDisplay[1];
  ...
  void _handleURLButtonPress(BuildContext context, var type) {
    Navigator.push(context,
        ...
        child: DependentImageFromGalleryEx(DirName: DirName.toString(),type: type, TypePath: "/LabTests", storage: ImageStorage(),))));
  }
                            ...
                            Container(
                              ...
                              child:TextField(
                                ...
                                onTap: () async {
                                  ...
                                  if(pickedDate != null ){
                                    //var outputFormat = intl.intl.DateFormat('MM/dd/yyyy hh:mm a');
                                    var outputFormat = intl.DateFormat('MM/dd/yyyy');
                              ...
                              child: PageType != false
                                ...
                                dropdownDecoratorProps: const DropDownDecoratorProps(
                                  dropdownSearchDecoration: InputDecoration(
                                    ...
                                    filled: false,
                                    labelText: "General LabTests",
                                    hintText: 'General LabTests',
                                ...
                                controller: GeneralLabTestsController,
                                onChanged: (value) {
                                  _GeneralLabTestsTxt = value;
                                  //get value from textField
                                },
                                decoration: const InputDecoration(
                                  border: OutlineInputBorder(),
                                  labelText: 'General Lab Tests',
                                  labelStyle: TextStyle(color: Color.fromRGBO(32, 116, 150, 1.0),
                                    fontSize: 16,
                                    //fontWeight: FontWeight.w500,
                                  ),
                                              ...
                                              MaterialPageRoute(builder:
                                                  (context) =>
                                                      Directionality( // use this
                                                          textDirection: LanguageData == 1 ?TextDirection.rtl :TextDirection.ltr ,
                                                          child: EditViewLabTestsPage(DirName: DirName.toString(),type: true, Data: DataToDisplay[0]+"\n"+DataToDisplay[1]+"\n"+DataToDisplay[2])
                                              )
                                              )
                                          );
                                        }
