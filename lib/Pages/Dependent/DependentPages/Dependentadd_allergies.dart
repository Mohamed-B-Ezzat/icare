...
class DependentAddAllergies extends StatefulWidget {
  final DependentAddAllergiesStorage storage;
  final String DataTitle;
  final String DataImage;
  final String DirName;

  DependentAddAllergies({Key? key ,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentAddAllergiesState createState() => _DependentAddAllergiesState(  this.DataTitle, this.DataImage,this.DirName);
}

class _DependentAddAllergiesState extends State<DependentAddAllergies> {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentAddAllergiesState(  this.DataTitle, this.DataImage,this.DirName);
  ...
  var GeneralAllergies = const ["Animals (Pets)","Food","Medicines (Drugs)","Insects","Environmental","Chemicals","Pollen","Latex","Other"];

  var _GeneralAllergies;
  var AllergyID;
  ...
  void _handleURLButtonPress(BuildContext context, var type) {
    Navigator.push(context,
        ...
        child: DependentImageFromGalleryEx(DirName: DirName.toString(),type: type, TypePath: "/Allergies", storage: ImageStorage(),)),));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      //extendBodyBehindAppBar: true,
        ...
        appBar: AppBar(
          title: const Text('Family Member Allergies',
            style: TextStyle(
              color: Colors.white,),
          ),
          centerTitle: true,
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: DropdownButtonFormField(
                                isDense: true,
                                isExpanded: true,
                                items: GeneralAllergies.map((String Symptom) {
                                ...
                                onChanged: (newValue) {
                                  ...
                                  _GeneralAllergies = newValue;
                                  AllergyID = GeneralAllergies.indexOf(newValue.toString());
                                },
                                value: _GeneralAllergies,
                                decoration: InputDecoration(
                                  ...
                                  // errorText: 'Select Sub Allergies',
                                ),
                              ),
                            ),
                            ...
                            //   child: DropdownButtonFormField(
                            //     isExpanded: true,
                            //     items: SubAllergies1.map((String Symptom) {
                            //       return  DropdownMenuItem(
                            //           value: Symptom,
                            //           child: Row(
                            //             children: <Widget>[
...
class DependentAddAllergiesStorage
{
...
// Find the Documents path
  ...
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/Allergies');
    var status = await Permission.storage.status;
    if (!status.isGranted) {
      await Permission.storage.request();
    }
