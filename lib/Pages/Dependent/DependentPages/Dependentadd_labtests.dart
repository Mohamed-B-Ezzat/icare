...
class DependentAddLabTests extends StatefulWidget {
  final DependentAddLabTestsStorage storage;

  final String DirName;
  final String DataTitle;
  final String DataImage;

  DependentAddLabTests({Key? key,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentAddLabTestsState createState() => _DependentAddLabTestsState(this.DataTitle, this.DataImage,this.DirName);
}

class _DependentAddLabTestsState extends State<DependentAddLabTests> {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentAddLabTestsState(this.DataTitle, this.DataImage,this.DirName);
...
class DependentAddLabTestsStorage
{
