...
import 'DependentPrescriptions.dart';
  ...
  class DependentAddPrescriptions extends StatefulWidget {
  final DependentAddPrescriptionsStorage storage;

  final String DirName;
  final String DataTitle;
  final String DataImage;

  DependentAddPrescriptions({Key? key,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentAddPrescriptionsState createState() => _DependentAddPrescriptionsState(this.DataTitle, this.DataImage,this.DirName);
}

class _DependentAddPrescriptionsState extends State<DependentAddPrescriptions> {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentAddPrescriptionsState(this.DataTitle, this.DataImage,this.DirName);
  ...
  void _handleURLButtonPress(BuildContext context, var type) {
    Navigator.push(context,
        ...
        child: DependentImageFromGalleryEx(DirName: DirName.toString(),type: type, TypePath: "/Prescriptions", storage: ImageStorage(),),)));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      //extendBodyBehindAppBar: true,
        ...
        appBar: AppBar(
          title: const Text('Family Member Prescriptions',
            style: TextStyle(
              color: Colors.white,),
          ),
          centerTitle: true,
...
class DependentAddPrescriptionsStorage
{
...
// Find the Documents path
  ...
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/Prescriptions');
    var status = await Permission.storage.status;
    if (!status.isGranted) {
      await Permission.storage.request();
    }
