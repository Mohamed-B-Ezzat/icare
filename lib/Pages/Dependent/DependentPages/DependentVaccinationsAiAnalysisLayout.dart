...
class DependentVaccinationsAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final DependentVaccinationsAnalysisStorage storage;
  final DependentVaccinationsPdfReport PrintPdf;
  final DependentVaccinationsWhoRecommendations WhoRecommendationsStorage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentVaccinationsAiAnalysisLayoutPage({required this.DataTitle, required this.DataImage, required this.DirName,required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.WhoRecommendationsStorage}) : super(key: key);

  @override
  _DependentVaccinationsAiAnalysisLayoutPageState createState() => _DependentVaccinationsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
}

class _DependentVaccinationsAiAnalysisLayoutPageState extends State<DependentVaccinationsAiAnalysisLayoutPage>  {
  ...
  var DataTitle;
  var DataImage;
  _DependentVaccinationsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
...
class DependentVaccinationsAnalysisStorage
{
...
class DependentVaccinationsPdfReport
{
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/AIAnalysis');
...
class DependentVaccinationsWhoRecommendations
{
