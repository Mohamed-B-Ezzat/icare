...
import 'DependentAppointments.dart';
  ...
  class DependentAddAppointments extends StatefulWidget {
  final DependentAddAppointmentsStorage storage;
  final String DataTitle;
  final String DataImage;
  final String DirName;

  DependentAddAppointments({Key? key ,required this.DataTitle, required this.DataImage,required this.DirName, required this.storage}) : super(key: key);

  @override
  _DependentAddAppointmentsState createState() => _DependentAddAppointmentsState(  this.DataTitle, this.DataImage, this.DirName);
  }

  class _DependentAddAppointmentsState extends State<DependentAddAppointments> {

  var DirName;
  var DataTitle;
  var DataImage;

  _DependentAddAppointmentsState(this.DataTitle, this.DataImage,this.DirName);
  ...
  void _handleURLButtonPress(BuildContext context, var type) {
    Navigator.push(context,
        ...
        child: DependentImageFromGalleryEx(DirName: DirName.toString(),type: type, TypePath: "/Appointments",storage: ImageStorage(),)),));
  }
...
class DependentAddAppointmentsStorage
{
