...
class DependentScansAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final DependentScansAnalysisStorage storage;
  final DependentScansPdfReport PrintPdf;
  final DependentScansActiveRecommendations RecommendationsStorage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentScansAiAnalysisLayoutPage({required this.DataTitle, required this.DataImage,required this.DirName, required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.RecommendationsStorage}) : super(key: key);

  @override
  _DependentScansAiAnalysisLayoutPageState createState() => _DependentScansAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
}

class _DependentScansAiAnalysisLayoutPageState extends State<DependentScansAiAnalysisLayoutPage>  {
  ...
  var DataTitle;
  var DataImage;
  _DependentScansAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
...
class DependentScansAnalysisStorage
{
...
class DependentScansActiveRecommendations
{
