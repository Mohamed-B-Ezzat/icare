...
class DependentPrescriptionsAiAnalysisLayoutPage extends StatefulWidget {
  String FromDate, ToDate, AnalysisModule;
  final DependentPrescriptionsAnalysisStorage storage;
  final DependentPrescriptionsPdfReport PrintPdf;
  final DependentPrescriptionsActiveIngredients IngeredientsStorage;
  final String DirName;
  final String DataTitle;
  final String DataImage;
  DependentPrescriptionsAiAnalysisLayoutPage({required this.DataTitle, required this.DataImage,required this.DirName, required this.FromDate, required this.ToDate, required this.AnalysisModule, Key? key, required this.storage, required this.PrintPdf, required this.IngeredientsStorage}) : super(key: key);

  @override
  _DependentPrescriptionsAiAnalysisLayoutPageState createState() => _DependentPrescriptionsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
}

class _DependentPrescriptionsAiAnalysisLayoutPageState extends State<DependentPrescriptionsAiAnalysisLayoutPage>  {
  ...
  var DataTitle;
  var DataImage;
  _DependentPrescriptionsAiAnalysisLayoutPageState(this.DataTitle, this.DataImage,this.DirName,this.FromDate, this.ToDate, this.AnalysisModule);
  ...
  void initState() {
    ...
    widget.storage._readData(DirName.toString(),ModuleFileName,ModuleDirName).then((String value) async{
      if(value != "No Data")
      {
        ...
        for(var Ingredient in IngredientsData)
        {
          widget.IngeredientsStorage._SearchIngredientsBank(Ingredient[0].toString()).then((String IngredientsInteractions) async{
            if(IngredientsInteractions != "")
            {
              ...
              PrescriptionsData[counter][4] = IngredientsInteractions;
              setState(() {
        ...
        //   {
        //     PrescriptionsData[i][4]=InteractionsListData[i];
        //   }
...
class DependentPrescriptionsAnalysisStorage
{
...
class DependentPrescriptionsPdfReport
{
  Future<String> createFolder(String DirName) async {
    var dir = await getApplicationDocumentsDirectory();
    final path = Directory('${dir.path}/ICare/'+DirName+'/AIAnalysis');
                    ...
                    pw.Row(
                        ...
                        children: [
                          ...
                          pw.Column(
                              ...
                              mainAxisAlignment: pw.MainAxisAlignment.center,
                              children: [
                                pw.Text("Doctor : "+Data[i][3].toString()+" / \n"+Data[i][1].toString(),
                                    style: const pw.TextStyle(fontSize: 14)),
                              ]
                          ),
                        ]
...
class DependentPrescriptionsActiveIngredients
{
