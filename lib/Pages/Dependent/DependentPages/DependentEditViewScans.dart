...
class DependentEditViewScansPage extends StatefulWidget {
  final  String Data;
  final String DirName;
  final bool type; // false for view and true for edit
  DependentEditViewScansPage({Key? key, required this.type, required this.Data, required this.DirName}) : super(key: key);
  @override
  _DependentEditViewScansPageState createState() => _DependentEditViewScansPageState(this.Data, this.type,this.DirName);
}
class _DependentEditViewScansPageState extends State<DependentEditViewScansPage>  {
  var DirName;
  var Data;
  var type;

  _DependentEditViewScansPageState(this.Data, this.type,this.DirName);
                                      ...
                                      if (ListData != "") {
                                        ...
                                        else
                                        {
                                          Navigator.pushReplacement(context,
                                              MaterialPageRoute(builder:
                                                  (context) =>
                                                  DependentEditViewScansPage(DirName: DirName.toString(),type: true, Data: DataToDisplay[0]+"\n"+DataToDisplay[1]+"\n"+DataToDisplay[2])
                                              )
                                          );
                                        }
                                      }
