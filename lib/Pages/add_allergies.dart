...
class AddAllergies extends StatefulWidget {
  final AddAllergiesStorage storage;

  AddAllergies({Key? key, required this.storage}) : super(key: key);
  @override
...
class _AddAllergiesState extends State<AddAllergies>  {
  ...
  var AddAllergyTitle = ["Add Allergy","اضافة حساسية",""];
  var DateTitle = ["Date","التاريخ",""];
  var AllergyTypeTitle = ["Allergy Type","نوع الحساسية",""];
  var AllergyCauseTitle = ["Allergy Cause","مسبب الحساسية",""];
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child:  Card(
                                  ...
                                  child: ListTile(
                                    title:Text(AddAllergyTitle[LanguageData],
                            ...
                            Container(
                              ...
                              child: DropdownButtonFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: AllergyTypeTitle[LanguageData],
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  border: const OutlineInputBorder(),
                                  labelText: AllergyCauseTitle[LanguageData],
                                  labelStyle: const TextStyle(color: Color.fromRGBO(32, 116, 150, 1.0),
                                    fontSize: 16,
                                    //fontWeight: FontWeight.w500,
                                  ),
