...
class RequestLocationPermissionsPage extends StatefulWidget {

  RequestLocationPermissionsPage({ Key? key}) : super(key: key);

  @override
  _RequestLocationPermissionsPageState createState() => _RequestLocationPermissionsPageState();
}

class _RequestLocationPermissionsPageState extends State<RequestLocationPermissionsPage> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Container(
                        color: Colors.transparent,
                        child: const Text("The application needs to allow Access to your location in order to enable all features to function properly such as AI Analysis and Emergency SOS messages ",textAlign: TextAlign.center,
                            ...
                            try {
                              ...
                              Navigator.pushReplacement(context,
                                  MaterialPageRoute(builder:
                                      (context) => Directionality( // use this
                                      textDirection: LanguageData == 1 ?ui.TextDirection.rtl :ui.TextDirection.ltr ,
                                      child: RequestLocationPermissionsPage()
                                  ),
                                  )
                              );
                            }
